...
export const settingsTranslations: Record<string, Record<Locale, string>> = {
  ...
  "settings.section.danger": { ja: "アカウント削除", en: "Delete Account", zh: "删除账户", ko: "계정 삭제" },
  "settings.section.danger.desc": { ja: "アカウントとクラウド上の全データを完全に削除します", en: "Permanently remove your account and all cloud data", zh: "永久删除账户及云端所有数据", ko: "계정과 클라우드의 모든 데이터를 영구적으로 삭제합니다" },
  "settings.deleteAccount": { ja: "アカウントを削除する", en: "Delete account", zh: "删除账户", ko: "계정 삭제하기" },
  "settings.deleteAccountConfirm": { ja: "本当に削除しますか？", en: "Are you sure?", zh: "确定要删除吗？", ko: "정말 삭제하시겠어요?" },
  "settings.deleteAccountWarning": { ja: "目標・タスク・集中記録・日記・設定を含むすべてのデータが完全に削除され、復元できません。", en: "Everything — goals, tasks, focus history, journal, settings — will be permanently deleted and cannot be recovered.", zh: "所有数据（目标、任务、专注记录、日记、设置）将被永久删除且无法恢复。", ko: "목표·작업·집중 기록·일기·설정을 포함한 모든 데이터가 영구 삭제되며 복구할 수 없습니다." },
  "settings.deleteAccountTypeEmail": { ja: "確認のため、メールアドレスを入力してください", en: "Type your email address to confirm", zh: "请输入您的邮箱以确认", ko: "확인을 위해 이메일 주소를 입력해 주세요" },
  "settings.deleteAccountConfirmButton": { ja: "完全に削除", en: "Delete forever", zh: "永久删除", ko: "영구 삭제" },
  "settings.cancel": { ja: "キャンセル", en: "Cancel", zh: "取消", ko: "취소" },
